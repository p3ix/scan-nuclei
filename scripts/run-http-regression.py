...
CASES = [
    ...
    Case(
        name="swagger-ui-short-path-positive",
        family="api-docs",
        scenario="swagger-common-positive",
        scan_mode="template",
        target="templates/exposures/swagger-ui-exposed.yaml",
        expected={"swagger-ui-exposed"},
        unexpected=set(),
    ),
    Case(
        name="openapi-json-api-path-positive",
        family="api-docs",
        scenario="swagger-common-positive",
        scan_mode="template",
        target="templates/exposures/openapi-json-exposed.yaml",
        expected={"openapi-json-exposed"},
        unexpected=set(),
    ),
    Case(
        name="openapi-yaml-api-path-positive",
        family="api-docs",
        scenario="swagger-common-positive",
        scan_mode="template",
        target="templates/exposures/openapi-yaml-exposed.yaml",
        expected={"openapi-yaml-exposed"},
        unexpected=set(),
    ),
    Case(
        name="swagger-config-positive",
        family="exposure",
        scenario="exposed-surfaces-positive",
        scan_mode="template",
        target="templates/exposures/swagger-config-exposed.yaml",
        expected={"swagger-config-exposed"},
        unexpected=set(),
    ),
    Case(
        name="graphql-ui-positive",
        family="exposure",
        scenario="exposed-surfaces-positive",
        scan_mode="template",
        target="templates/exposures/apis/graphql-ui-exposed.yaml",
        expected={"graphql-ui-exposed"},
        unexpected=set(),
    ),
    Case(
        name="spring-boot-admin-ui-positive",
        family="exposure",
        scenario="exposed-surfaces-positive",
        scan_mode="template",
        target="templates/misconfiguration/java-apps/spring-boot-admin-ui-exposed.yaml",
        expected={"spring-boot-admin-ui-exposed"},
        unexpected=set(),
    ),
    Case(
        name="eureka-dashboard-positive",
        family="exposure",
        scenario="exposed-surfaces-positive",
        scan_mode="template",
        target="templates/misconfiguration/java-apps/eureka-dashboard-exposed.yaml",
        expected={"eureka-dashboard-exposed"},
        unexpected=set(),
    ),
    Case(
        name="zipkin-ui-positive",
        family="exposure",
        scenario="exposed-surfaces-positive",
        scan_mode="template",
        target="templates/misconfiguration/java-apps/zipkin-ui-exposed.yaml",
        expected={"zipkin-ui-exposed"},
        unexpected=set(),
    ),
    Case(
        name="spring-cloud-config-server-positive",
        family="exposure",
        scenario="exposed-surfaces-positive",
        scan_mode="template",
        target="templates/misconfiguration/java-apps/spring-cloud-config-server-exposed.yaml",
        expected={"spring-cloud-config-server-exposed"},
        unexpected=set(),
    ),
    Case(
    ...
    Case(
        name="spring-actuator-health-details-positive",
        family="spring",
        scenario="spring-positive",
        scan_mode="template",
        target="templates/vulnerabilities/spring/spring-actuator-health-details-unauth.yaml",
        expected={"spring-actuator-health-details-unauth"},
        unexpected=set(),
    ),
    Case(
        name="spring-actuator-info-build-git-positive",
        family="spring",
        scenario="spring-positive",
        scan_mode="template",
        target="templates/vulnerabilities/spring/spring-actuator-info-build-git-exposed.yaml",
        expected={"spring-actuator-info-build-git-exposed"},
        unexpected=set(),
    ),
    Case(
        name="java-build-metadata-positive",
        family="java",
        scenario="spring-positive",
        scan_mode="template",
        target="templates/exposures/sensitive-paths/java-build-metadata-exposed.yaml",
        expected={"java-build-metadata-exposed"},
        unexpected=set(),
    ),
    Case(
        name="java-cache-config-positive",
        family="java",
        scenario="jetty-positive",
        scan_mode="template",
        target="templates/exposures/sensitive-paths/java-cache-config-exposed.yaml",
        expected={"java-cache-config-exposed"},
        unexpected=set(),
    ),
    Case(
        name="java-messaging-config-positive",
        family="java",
        scenario="jetty-positive",
        scan_mode="template",
        target="templates/exposures/sensitive-paths/java-messaging-config-exposed.yaml",
        expected={"java-messaging-config-exposed"},
        unexpected=set(),
    ),
    Case(
        name="java-security-config-positive",
        family="java",
        scenario="jetty-positive",
        scan_mode="template",
        target="templates/exposures/sensitive-paths/java-security-config-exposed.yaml",
        expected={"java-security-config-exposed"},
        unexpected=set(),
    ),
    Case(
        name="jsf-jakarta-faces-fingerprint-positive",
        family="jsf",
        scenario="jsf-positive",
        scan_mode="template",
        target="templates/technologies/java-web/jsf-jakarta-faces-fingerprint.yaml",
        expected={"jsf-jakarta-faces-fingerprint"},
        unexpected=set(),
    ),
    Case(
        name="primefaces-resource-fingerprint-positive",
        family="jsf",
        scenario="jsf-positive",
        scan_mode="template",
        target="templates/technologies/java-web/primefaces-resource-fingerprint.yaml",
        expected={"primefaces-resource-fingerprint"},
        unexpected=set(),
    ),
    Case(
        name="jsf-faces-config-positive",
        family="jsf",
        scenario="jsf-positive",
        scan_mode="template",
        target="templates/exposures/sensitive-paths/jsf-faces-config-exposed.yaml",
        expected={"jsf-faces-config-exposed"},
        unexpected=set(),
    ),
    Case(
        name="jakarta-ee-descriptors-positive",
        family="jsf",
        scenario="jsf-positive",
        scan_mode="template",
        target="templates/exposures/sensitive-paths/jakarta-ee-descriptors-exposed.yaml",
        expected={"jakarta-ee-descriptors-exposed"},
        unexpected=set(),
    ),
    Case(
        name="jakarta-faces-stacktrace-positive",
        family="jsf",
        scenario="jsf-positive",
        scan_mode="template",
        target="templates/exposures/error-pages/jakarta-faces-stacktrace-exposed.yaml",
        expected={"jakarta-faces-stacktrace-exposed"},
        unexpected=set(),
    ),
    Case(
        name="jsf-jakarta-faces-workflow-positive",
        family="jsf",
        scenario="jsf-positive",
        scan_mode="workflow",
        target="templates/workflows/java/jsf-jakarta-faces-workflow.yaml",
        expected={
            "jakarta-ee-descriptors-exposed",
            "jakarta-faces-stacktrace-exposed",
            "jsf-faces-config-exposed",
            "primefaces-resource-fingerprint",
        },
        unexpected=set(),
    ),
    Case(
    ...
    Case(
        name="spring-actuator-busrefresh-write-surface-positive",
        family="spring",
        scenario="spring-positive",
        scan_mode="template",
        target="templates/misconfiguration/java-apps/spring-actuator-busrefresh-write-surface-potential.yaml",
        expected={"spring-actuator-busrefresh-write-surface-potential"},
        unexpected=set(),
    ),
    Case(
        name="spring-actuator-busenv-write-surface-positive",
        family="spring",
        scenario="spring-positive",
        scan_mode="template",
        target="templates/misconfiguration/java-apps/spring-actuator-busenv-write-surface-potential.yaml",
        expected={"spring-actuator-busenv-write-surface-potential"},
        unexpected=set(),
    ),
    Case(
        name="spring-actuator-refresh-write-surface-positive",
        family="spring",
        scenario="spring-positive",
        scan_mode="template",
        target="templates/misconfiguration/java-apps/spring-actuator-refresh-write-surface-potential.yaml",
        expected={"spring-actuator-refresh-write-surface-potential"},
        unexpected=set(),
    ),
    Case(
        name="spring-actuator-restart-write-surface-positive",
        family="spring",
        scenario="spring-positive",
        scan_mode="template",
        target="templates/misconfiguration/java-apps/spring-actuator-restart-write-surface-potential.yaml",
        expected={"spring-actuator-restart-write-surface-potential"},
        unexpected=set(),
    ),
    Case(
    ...
    Case(
        ...
        expected={
            "java-build-metadata-exposed",
            "java-loggers-endpoint-exposed",
            "spring-actuator-auditevents-unauth",
            "spring-actuator-busenv-write-surface-potential",
            "spring-actuator-busrefresh-write-surface-potential",
            "spring-actuator-flyway-unauth",
            "spring-actuator-gateway-refresh-write-surface-potential",
            "spring-actuator-health-details-unauth",
            "spring-actuator-info-build-git-exposed",
            "spring-actuator-liquibase-unauth",
            "spring-actuator-prometheus-exposed",
            "spring-actuator-quartz-unauth",
            "spring-actuator-refresh-write-surface-potential",
            "spring-actuator-restart-write-surface-potential",
            "spring-actuator-shutdown-write-surface-potential",
        },
        unexpected=set(),
    ),
    Case(
        name="jetty-server-header-fingerprint-positive",
        family="jetty",
        scenario="jetty-positive",
        scan_mode="template",
        target="templates/technologies/jetty/jetty-server-header-fingerprint.yaml",
        expected={"jetty-server-header-fingerprint"},
        unexpected=set(),
    ),
    Case(
        name="jetty-config-files-positive",
        family="jetty",
        scenario="jetty-positive",
        scan_mode="template",
        target="templates/exposures/sensitive-paths/jetty-config-files-exposed.yaml",
        expected={"jetty-config-files-exposed"},
        unexpected=set(),
    ),
    Case(
        name="jetty-realm-properties-positive",
        family="jetty",
        scenario="jetty-positive",
        scan_mode="template",
        target="templates/exposures/sensitive-paths/jetty-realm-properties-exposed.yaml",
        expected={"jetty-realm-properties-exposed"},
        unexpected=set(),
    ),
    Case(
        name="jetty-default-error-page-fingerprint-positive",
        family="jetty",
        scenario="jetty-positive",
        scan_mode="template",
        target="templates/technologies/jetty/jetty-default-error-page-fingerprint.yaml",
        expected={"jetty-default-error-page-fingerprint"},
        unexpected=set(),
    ),
    Case(
        name="jetty-java-exposure-workflow-positive",
        family="jetty",
        scenario="jetty-positive",
        scan_mode="workflow",
        target="templates/workflows/java/jetty-fingerprint-to-java-exposure-workflow.yaml",
        expected={
            "java-cache-config-exposed",
            "java-messaging-config-exposed",
            "java-security-config-exposed",
            "jetty-config-files-exposed",
            "jetty-realm-properties-exposed",
        },
        unexpected=set(),
    ),
]
